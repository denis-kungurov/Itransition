...
namespace SellYourTime.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            ...
            ModelState.AddModelError("", @Resources.Resource.ErrorLoginOrPass);
            return View(model);
        }
        ...
        public ActionResult Manage(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.RemoveLoginSuccess ? @Resources.Resource.ExtLoginRemover
                : "";
        ...
        public ActionResult Manage(LocalPasswordModel model)
        {
            ...
            if (hasLocalAccount)
            {
                if (ModelState.IsValid)
                {
                    ...
                    {
                        ModelState.AddModelError("", @Resources.Resource.ErrorPass1);
                    }
                }
            }
            else
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    {
                        ModelState.AddModelError("", String.Format(@Resources.Resource.ErrorUsr1+"{0}" + @Resources.Resource.ErrorUsr2, User.Identity.Name));
                    }
                }
            }
        ...
        public ActionResult AdminPage(int? offerId)
        {
            ViewBag.Users = _repo.GetAllUsers();
            ViewBag.Offers = _repo.GetAllOffers();
            return View();
        }
